...
{ 
  ...
  public likeProducts: ReturnProductListDto[] = []; 
  ...
  goToRootPanel(){
    this.router.navigate(['/root-panel-page']);
  }
  ...
  customYAxisFormat(value: number): string {
    ...
    showUserProject: boolean = false;
      ...
      toggleDropdown3(index: number): void {
        console.log('Dropdown before:', this.dropdownOpen2);
        this.dropdownOpen2[index] = !this.dropdownOpen2[index];
        console.log('Dropdown after:', this.dropdownOpen2);
      }
      ...
      filteredItems = this.items;
        ...
        ngOnInit() 
        {
          ...
          this.rule = this.userService.getUserRole();
          ...
          this.shopService.getLikedProducts ().subscribe({
            next: (data) => {
        ...
        getUserProjects(): void{
          ...
          this.dropdownOpen2 = this.userProjectList.map(() => false);
        }
        ...
        toggleLike2(index: number): void {
          ...
          toggleLike3(id: string, i: number) {

            this.shopService.toggleLike(id).subscribe({
              next: () => {
                this.likeProducts[i].isFavourite = !this.likeProducts[i].isFavourite;
              },
              error: (error) => {
