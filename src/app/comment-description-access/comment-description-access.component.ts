...
@Component({
  selector: 'app-comment-description-access',
  imports: [
  ...
  templateUrl: './comment-description-access.component.html',
  styleUrl: './comment-description-access.component.scss'
})
export class CommentDescriptionAccessComponent 
{
