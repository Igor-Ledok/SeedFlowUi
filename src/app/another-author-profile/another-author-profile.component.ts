...
@Component({
  selector: 'app-another-author-profile',
  imports: 
  [
    CommonModule, 
    RouterModule,
  ...
  templateUrl: './another-author-profile.component.html',
  styleUrl: './another-author-profile.component.scss'
})
export class AnotherAuthorProfileComponent {
