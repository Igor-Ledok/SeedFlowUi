...
export class GeneralComponent 
{
  ...
  clearFile(): void {
    this.projectData.BudgetPlanUrl = null;
    this.projectData.SelectedFileNameDocx = null;
    const input = document.getElementById('budget-file') as HTMLInputElement;
    if (input) {
      input.value = '';
    }
  }
...
handleNextClick() {
  ...
  if (this.projectData.BudgetPlan.length < 10) 
  {
    this.fileError = 'Текст має містити щонайменше 10 символів';
    isValid2 = false;
  }
