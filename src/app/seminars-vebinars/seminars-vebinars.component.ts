...
@Component({
  selector: 'app-seminars-vebinars',
  imports: 
  [
    CommonModule, 
    RouterModule,
  ...
  templateUrl: './seminars-vebinars.component.html',
  styleUrl: './seminars-vebinars.component.scss'
})
export class SeminarsVebinarsComponent {
    ...
    public statusjwt: boolean = false;
      ...
      comments = [
        ...
        },
        {
         ...
         image: "assets/images/WithoutPhoto.png"
        },
        {
         name: "Марія Петренко",
