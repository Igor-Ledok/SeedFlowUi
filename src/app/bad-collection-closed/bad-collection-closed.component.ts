...
@Component({
  selector: 'app-bad-collection-closed',
  imports: 
  [
    CommonModule, 
    RouterModule,
  ...
  templateUrl: './bad-collection-closed.component.html',
  styleUrl: './bad-collection-closed.component.scss'
})
export class BadCollectionClosedComponent {
